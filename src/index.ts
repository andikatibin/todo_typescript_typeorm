...
import { DeleteDateColumn, MetadataWithSuchNameAlreadyExistsError, TableColumn } from "typeorm";
    ...
    */
    ...
    do {
        ...
        if (parseInt(input_menu) === Number(1)) {
            ...
            const data_Task = await AppDataSource.getManyToManyMetadata.call(Task, {
                TableColumn: Task,
            });
            ...
            const task_number = prompt("Silahkan Pilih Nomor Task : ");
            const input_task_number_int = Number(input_task_number)
            ...
            // hapus data
            const view_task_number_int = Number(input_task_number)
            
            task = await AppDataSource.manager.findOneBy(Task, {
                id: input_task_number_int,
            });
